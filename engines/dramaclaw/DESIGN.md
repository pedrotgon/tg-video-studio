...
## TG Video Studio adaptation

The local TG distribution preserves all DramaClaw product surfaces and applies
one presentation layer through the existing semantic tokens:

- Forest Green `#19382B`: primary actions, navigation and foreground.
- Champagne Gold `#C5A880`: focus, selection and premium accent.
- Cloud Dancer `#F0EEE9`: application background.
- Paper `#FBFAF7`: cards and popovers.
- `Plus Jakarta Sans`: headings; `DM Sans`: interface and body copy.

The adaptation changes neither product topology nor workflow behavior. Original
copyright and Elastic License 2.0 attribution remain visible and intact.
