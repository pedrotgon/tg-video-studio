  ...
  ({
    ...
    return (
      ...
      >
        <button
          type="button"
          aria-label="Conexões em lote"
          title="Conexão em lote: clique para criar um novo nó downstream e conectar todos os nós selecionados ou arraste para conectar a um nó existente"
