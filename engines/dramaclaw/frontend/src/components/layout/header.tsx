...
export function Header() {
  ...
  const activeLanguage = resolvedLanguage.startsWith("pt")
    ? "pt"
    : resolvedLanguage.startsWith("zh") ? "zh" : "en";
  ...
  const switchLanguage = (lang: "pt" | "zh" | "en") => {
...
function AccountPanel({
  ...
  activeLanguage: "pt" | "zh" | "en";
  avatarInitial: string;
  avatarUrl: string | null;
  displayName: string;
  onChangeAvatar: () => void;
  onLanguageChange: (lang: "pt" | "zh" | "en") => void;
  onClose: () => void;
  onEnter: () => void;
  onLogout?: () => void;
  ...
  const activeLanguageLabel = activeLanguage === "pt"
    ? "Português (Brasil)"
    : activeLanguage === "zh" ? t("header.account.languageChinese") : t("header.account.languageEnglish");
