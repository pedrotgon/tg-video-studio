...
export const SimpleVideoTab: React.FC<Props> = ({ onGenerate, activeJob, onStepChange }) => {
  ...
  return <div className="mx-auto max-w-5xl space-y-5">
    ...
    {step === 3 && <Panel title="3. Tom e voz" subtitle="Escolha a entrega da fala e o formato do vídeo.">
      <div className="grid gap-5 md:grid-cols-2"><Select label="Tom" value={tone} onChange={(value) => setTone(value as NonNullable<SimpleVideoConfig['tone']>)} options={[['direto', 'Direto e objetivo'], ['proximo', 'Próximo e acolhedor'], ['energetico', 'Energético e motivador'], ['especialista', 'Especialista e didático']]} /><Select label="Voz" value={voice} onChange={setVoice} options={[['pt-BR-FranciscaNeural', 'Francisca · feminina, natural e clara'], ['pt-BR-AntonioNeural', 'Antônio · masculino, confiante e dinâmico'], ['pt-BR-ThalitaMultilingualNeural', 'Thalita · feminina, jovem e expressiva']]} /></div>
